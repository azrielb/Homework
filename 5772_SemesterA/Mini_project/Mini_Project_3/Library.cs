...
namespace municipalyLibraries
{
    ...
    class Library
    {
        ...
        virtual public int addBook(string name, string author = "", bookTypes bookType = bookTypes.Unknown,
        ...
        virtual public int addClient(string name)
        {
        ...
        virtual public int addClient(LibraryClient newClient)
        {
            if (newClient == null || newClient.ClientID == 0)
                return -1;
            int counter = clients.Count;
        ...
        virtual public bool borrow(out string message, int clientIndex, int bookIndex, string nubmer = "", uint expiration = 0)
        {
        ...
        virtual public bool returnBook(out string message, int clientIndex, int bookIndex)
        {
            LibraryBook book = (LibraryBook)books[bookIndex];
            message = book == null ? "The book does not exists! " : "";
            LibraryClient client = (LibraryClient)clients[clientIndex];
